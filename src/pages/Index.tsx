  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="py-16 bg-scripture/10">
        <ScriptureQuote 
          text="I can do all things through Christ who strengthens me. It is a powerful message of strength and resilience, often interpreted as a promise that God will provide the power needed to endure hardship and live a life pleasing to Him. The verse is frequently shortened to I can do all things, but it's important to remember the context: it's about doing what God calls us to do, not anything we want to do"
